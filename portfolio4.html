...
<html lang="en">
<head>
<title>Caprice | Portfolio 1 Column</title>
<meta charset="UTF-8">
    ...
    <div id="portfolio">
      ...
      <div class="items">
        <div class="box col1 web">
          <div class="left-side"> <a href="style/images/art/p1-full.jpg" rel="prettyPhoto[portfolio]" title="Caption"><span class="overlay zoom"></span><img src="style/images/art/p4-1.jpg" alt=""></a> </div>
          <div class="right-side">
            <h4><a href="portfolio-post.html">Euismod Ridiculus Mollis Sem</a></h4>
            ...
            <a href="portfolio-post.html" class="button blue">View Project</a> </div>
        </div>
        <div class="box col1 photo">
          <div class="left-side"> <a href="style/images/art/p1-full.jpg" rel="prettyPhoto[portfolio]" title="Caption"><span class="overlay zoom"></span><img src="style/images/art/p4-2.jpg" alt=""></a> </div>
          <div class="right-side">
            <h4><a href="portfolio-post.html">Ligula Risus Porta Condimentum Consectetur</a></h4>
        ...
        <div class="box col1 video">
          <div class="left-side"> <a href="style/images/art/p1-full.jpg" rel="prettyPhoto[portfolio]" title="Caption"><span class="overlay play"></span><img src="style/images/art/p4-3.jpg" alt=""></a> </div>
          <div class="right-side">
            <h4><a href="portfolio-post.html">Ultricies Quam Pellentesque</a></h4>
        ...
        <div class="box col1 web">
          <div class="left-side"> <a href="style/images/art/p12-full.jpg" rel="prettyPhoto[portfolio]" title="Caption"><span class="overlay zoom"></span><img src="style/images/art/p4-4.jpg" alt=""></a> </div>
          <div class="right-side">
            <h4><a href="portfolio-post.html">Dolor Purus Mollis</a></h4>
        ...
        <div class="box col1 video">
          <div class="left-side"> <a href="style/images/art/p1-full.jpg" rel="prettyPhoto[portfolio]" title="Caption"><span class="overlay play"></span><img src="style/images/art/p4-5.jpg" alt=""></a> </div>
          <div class="right-side">
            <h4><a href="portfolio-post.html">Dolor Tristique Commodo</a></h4>
        ...
        <div class="box col1 photo">
          <div class="left-side"> <a href="style/images/art/p1-full.jpg" rel="prettyPhoto[portfolio]" title="Caption"><span class="overlay zoom"></span><img src="style/images/art/p4-6.jpg" alt=""></a> </div>
          <div class="right-side">
            <h4><a href="portfolio-post.html">Aenean Nibh Ornare</a></h4>
        ...
        <div class="box col1 video">
          <div class="left-side"> <a href="style/images/art/p1-full.jpg" rel="prettyPhoto[portfolio]" title="Caption"><span class="overlay play"></span><img src="style/images/art/p4-7.jpg" alt=""></a> </div>
          <div class="right-side">
            <h4><a href="portfolio-post.html">Elit Ullamcorper Parturient</a></h4>
        ...
        <div class="box col1 web">
          <div class="left-side"> <a href="style/images/art/p1-full.jpg" rel="prettyPhoto[portfolio]" title="Caption"><span class="overlay zoom"></span><img src="style/images/art/p4-8.jpg" alt=""></a> </div>
          <div class="right-side">
            <h4><a href="portfolio-post.html">Venenatis Adipiscing Fusce</a></h4>
