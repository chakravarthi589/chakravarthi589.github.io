...
<html lang="en">
<head>
<title>Caprice | Post w/ Sidebar</title>
<meta charset="UTF-8">
...
<div id="wrapper">
  ...
  fjs.parentNode.insertBefore(js, fjs);
      ...
      <div class="fb-comments" data-href="#" data-num-posts="10" data-width="470"></div>
    </div>
    <div class="secondary">
      <div class="sidebox">
        <h3>Categories</h3>
      ...
      <div class="sidebox">
        <h3>Custom Text</h3>
        <p>Curabitur blandit tempus porttitor. Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor.</p>
