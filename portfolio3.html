...
<html lang="en">
<head>
<title>Caprice | Portfolio 2 Columns</title>
<meta charset="UTF-8">
    ...
    <div id="portfolio">
      ...
      <div class="items">
        <div class="box col2 web">
          <div class="image"> <a href="style/images/art/p1-full.jpg" rel="prettyPhoto[portfolio]" title="Caption"><span class="overlay zoom"></span><img src="style/images/art/p3-1.jpg" alt=""></a> </div>
          <h4><a href="portfolio-post.html">Cras Ridiculus Justo Porta Ligula</a></h4>
        ...
        <div class="box col2 photo">
          <div class="image"> <a href="style/images/art/p1-full.jpg" rel="prettyPhoto[portfolio]" title="Caption"><span class="overlay zoom"></span><img src="style/images/art/p3-2.jpg" alt=""></a> </div>
          <h4><a href="portfolio-post.html">Ullamcorper Sit Nibh Purus Fusce</a></h4>
          <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit.</p>
        </div>
        <div class="box col2 video">
          <div class="image"> <a href="style/images/art/p1-full.jpg" rel="prettyPhoto[portfolio]" title="Caption"><span class="overlay play"></span><img src="style/images/art/p3-3.jpg" alt=""></a> </div>
          <h4><a href="portfolio-post.html">Nibh Consectetur Malesuada Egestas</a></h4>
          <p>Cras mattis consectetur purus sit amet fermentum. Vivamus sagittis lacus vel augue laoreet rutrum dolor.</p>
        </div>
        <div class="box col2 web">
          <div class="image"> <a href="style/images/art/p1-full.jpg" rel="prettyPhoto[portfolio]" title="Caption"><span class="overlay zoom"></span><img src="style/images/art/p3-4.jpg" alt=""></a> </div>
          <h4><a href="portfolio-post.html">Ullamcorper Venenatis Commodo Fermentum</a></h4>
          <p>Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet.</p>
        </div>
        <div class="box col2 video">
          <div class="image"> <a href="style/images/art/p1-full.jpg" rel="prettyPhoto[portfolio]" title="Caption"><span class="overlay play"></span><img src="style/images/art/p3-5.jpg" alt=""></a> </div>
          <h4><a href="portfolio-post.html">Vestibulum Justo Nibh Ultricies Sem</a></h4>
          <p>Aenean lacinia bibendum nulla sed consectetur. Donec ullamcorper nulla non metus auctor fringilla.</p>
        </div>
        <div class="box col2 photo">
          <div class="image"> <a href="style/images/art/p1-full.jpg" rel="prettyPhoto[portfolio]" title="Caption"><span class="overlay zoom"></span><img src="style/images/art/p3-6.jpg" alt=""></a> </div>
          <h4><a href="portfolio-post.html">Ligula Fusce Pellentesque Magna Malesuada</a></h4>
          <p>Curabitur blandit tempus porttitor. Donec ullamcorper nulla non metus auctor fringilla.</p>
        </div>
        <div class="box col2 photo">
          <div class="image"> <a href="style/images/art/p1-full.jpg" rel="prettyPhoto[portfolio]" title="Caption"><span class="overlay zoom"></span><img src="style/images/art/p3-7.jpg" alt=""></a> </div>
          <h4><a href="portfolio-post.html">Fusce Amet Malesuada Nullam Porta</a></h4>
          <p>Maecenas sed diam eget risus varius blandit sit amet non magna. Fusce dapibus, tellus ac cursus commodo.</p>
        </div>
        <div class="box col2 web">
          <div class="image"> <a href="style/images/art/p1-full.jpg" rel="prettyPhoto[portfolio]" title="Caption"><span class="overlay zoom"></span><img src="style/images/art/p3-8.jpg" alt=""></a> </div>
          <h4><a href="portfolio-post.html">Fusce Mattis Sollicitudin Cursus Dolor</a></h4>
          <p>Donec ullamcorper nulla non metus auctor fringilla. Cras justo odio, dapibus ac facilisis in, egestas eget quam.</p>
        </div>
        <div class="box col2 web">
          <div class="image"> <a href="style/images/art/p1-full.jpg" rel="prettyPhoto[portfolio]" title="Caption"><span class="overlay zoom"></span><img src="style/images/art/p3-9.jpg" alt=""></a> </div>
          <h4><a href="portfolio-post.html">Elit Ligula Dapibus Ornare Nullam</a></h4>
          <p>Etiam porta sem malesuada magna mollis euismod. Donec id elit non mi porta gravida at eget metus.</p>
        </div>
        <div class="box col2 video">
          <div class="image"> <a href="style/images/art/p1-full.jpg" rel="prettyPhoto[portfolio]" title="Caption"><span class="overlay play"></span><img src="style/images/art/p3-10.jpg" alt=""></a> </div>
          <h4><a href="portfolio-post.html">Pharetra Amet Fermentum Justo Vestibulum</a></h4>
