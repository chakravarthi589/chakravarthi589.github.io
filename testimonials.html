...
<html lang="en">
<head>
<title>Caprice | Testimonials</title>
<meta charset="UTF-8">
...
<div id="wrapper">
  ...
  <div id="content">
    ...
    <ul class="testimonials">
      <li>
        <blockquote>
          <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec ullamcorper nulla non metus auctor fringilla. Donec ullamcorper nulla non metus auctor fringilla. Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Vestibulum id ligula porta felis euismod semper.</p>
        </blockquote>
        <cite>&ndash; Dapibus Fusce</cite> </li>
      <li>
        <blockquote>
          <p>Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Maecenas faucibus mollis interdum. Sed posuere consectetur est at lobortis. Aenean lacinia bibendum nulla sed consectetur. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
        </blockquote>
        <cite>&ndash; Cursus Risus</cite> </li>
      <li>
        <blockquote>
        ...
        <cite>&ndash; Parturient Dapibus Ultricies</cite> </li>
      <li>
        <blockquote>
          <p>Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Cras mattis consectetur purus sit amet fermentum. Curabitur blandit tempus porttitor. Sed posuere consectetur est at lobortis. Nullam quis risus eget urna mollis ornare vel eu leo. Curabitur blandit tempus porttitor.</p>
        </blockquote>
        <cite>&ndash; Nullam Ornare</cite> </li>
    </ul>
    <div id="footer">
