    ...
    <div id="portfolio">
      ...
      <div class="items">
        <div class="box col3 web">
          <div class="image"> <a href="style/images/art/p1-full.jpg" rel="prettyPhoto" title="Caption"><span class="overlay zoom"></span><img src="style/images/art/p2-1.jpg" alt=""></a> </div>
          <h4><a href="#">Vestibulum Tellus</a></h4>
          <p>Cum sociis natoque penatibus et magnis dis parturient montes.</p>
        </div>
        <div class="box col3 photo">
          <div class="image"> <a href="style/images/art/p2-full.jpg" rel="prettyPhoto" title="Caption"><span class="overlay zoom"></span><img src="style/images/art/p2-2.jpg" alt=""></a> </div>
          <h4><a href="#">Malesuada Magna</a></h4>
          <p>Nullam quis risus eget urna mollis ornare vel eu leo.</p>
        </div>
        <div class="box col3 graphic">
          <div class="image"> <a href="style/images/art/p3-full.jpg" rel="prettyPhoto" title="Caption"><span class="overlay zoom"></span><img src="style/images/art/p2-3.jpg" alt=""></a> </div>
          <h4><a href="#">Egestas Risus</a></h4>
          <p>Integer posuere erat a ante venenatis dapibus posuere velit aliquet.</p>
        </div>
        <div class="box col3 web">
          <div class="image"> <a href="style/images/art/p4-full.jpg" rel="prettyPhoto" title="Caption"><span class="overlay zoom"></span><img src="style/images/art/p2-4.jpg" alt=""></a> </div>
          <h4><a href="#">Bibendum Ullamcorper</a></h4>
          <p>Aenean eu leo quam. Pellentesque ornare sem lacinia vestibulum.</p>
        </div>
        <div class="box col3 graphic">
          <div class="image"> <a href="style/images/art/p5-full.jpg" rel="prettyPhoto" title="Caption"><span class="overlay zoom"></span><img src="style/images/art/p2-5.jpg" alt=""></a> </div>
          <h4><a href="#">Commodo Bibendum</a></h4>
          <p>Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor.</p>
        </div>
        <div class="box col3 photo">
          <div class="image"> <a href="style/images/art/p6-full.jpg" rel="prettyPhoto" title="Caption"><span class="overlay zoom"></span><img src="style/images/art/p2-6.jpg" alt=""></a> </div>
          <h4><a href="#">Sollicitudin Lorem</a></h4>
          <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula.</p>
        </div>
        <div class="box col3 photo">
          <div class="image"> <a href="style/images/art/p7-full.jpg" rel="prettyPhoto" title="Caption"><span class="overlay zoom"></span><img src="style/images/art/p2-7.jpg" alt=""></a> </div>
          <h4><a href="#">Cursus Mattis</a></h4>
          <p>Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor.</p>
        </div>
        <div class="box col3 web">
          <div class="image"> <a href="style/images/art/p8-full.jpg" rel="prettyPhoto" title="Caption"><span class="overlay zoom"></span><img src="style/images/art/p2-8.jpg" alt=""></a> </div>
          <h4><a href="#">Sit Porta Purus</a></h4>
          <p>Morbi leo risus, porta ac consectetur ac, vestibulum at eros.</p>
        </div>
        <div class="box col3 web">
          <div class="image"> <a href="style/images/art/p9-full.jpg" rel="prettyPhoto" title="Caption"><span class="overlay zoom"></span><img src="style/images/art/p2-9.jpg" alt=""></a> </div>
          <h4><a href="#">Fermentum Porta</a></h4>
          <p>Praesent commodo cursus magna, vel scelerisque nisl consectetur et.</p>
        </div>
        <div class="box col3 photo">
          <div class="image"> <a href="style/images/art/p10-full.jpg" rel="prettyPhoto" title="Caption"><span class="overlay zoom"></span><img src="style/images/art/p2-10.jpg" alt=""></a> </div>
          <h4><a href="#">Risus Venenatis</a></h4>
          <p>Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis.</p>
        </div>
        <div class="box col3 graphic">
          <div class="image"> <a href="style/images/art/p11-full.jpg" rel="prettyPhoto" title="Caption"><span class="overlay zoom"></span><img src="style/images/art/p2-11.jpg" alt=""></a> </div>
          <h4><a href="#">Nullam Commodo</a></h4>
          <p>Fusce dapibus, tellus ac cursus commodo, mauris condimentum.</p>
        </div>
        <div class="box col3 web">
          <div class="image"> <a href="style/images/art/p12-full.jpg" rel="prettyPhoto" title="Caption"><span class="overlay zoom"></span><img src="style/images/art/p2-12.jpg" alt=""></a> </div>
          <h4><a href="#">Vestibulum Tellus</a></h4>
