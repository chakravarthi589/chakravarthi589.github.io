...
<html lang="en">
<head>
<title>Caprice | Tabs Toggle Tables</title>
<meta charset="UTF-8">
...
<div id="wrapper">
  ...
  <div id="content">
    <h1 class="title">Tabs, Toggle and Tables</h1>
    <div class="line"></div>
    ...
    <div class="toggle">
      ...
      <div class="togglebox">
        <div>
          <h4>Vestibulum ullamcorper</h4>
          <p><img src="style/images/art/p3.jpg" class="left" alt="">Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Nulla facilisi. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nunc rhoncus tortor quis eros bibendum a tempus est dapibus. Vivamus consectetur quam eu tellus porttitor ultrices. Nunc metus massa, ullamcorper sit amet malesuada a, porttitor in tellus.</p>
        </div>
      </div>
    </div>
    <div class="toggle">
      ...
      <div class="togglebox">
        <div>
          <h4>Vestibulum ullamcorper</h4>
          <p><img src="style/images/art/p4.jpg" class="left" alt="">Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Nulla facilisi. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nunc rhoncus tortor quis eros bibendum a tempus est dapibus. Vivamus consectetur quam eu tellus porttitor ultrices. Nunc metus massa, ullamcorper sit amet malesuada a, porttitor in tellus.</p>
        </div>
      </div>
    </div>
    <br>
    ...
    <table>
      <tr>
        ...
        <th class="center"><h4>Centered Header 3</h4></th>
      </tr>
      <tr>
        <td>Division 1</td>
        <td>Division 2</td>
